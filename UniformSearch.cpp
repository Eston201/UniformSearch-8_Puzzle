...
//three below not used somehow
bool InPQ(priority_queue<Node* , vector<Node*> ,Compare > pq, string c){
...
bool IsInPQ(priority_queue<Node* , vector<Node*> ,Compare > pq, Node *C){
    ...
    while(!pq.empty()){
        ...
        if((node->state == C->state) && (C->cost < node->cost) ){
            isIn = true;
            break;
        }
...
void ReplaceNode(priority_queue<Node* , vector<Node*> ,Compare > &pq, Node *C){
    ...
    while(!pq.empty()){
        ...
        if((temp->state == C->state) && (C->cost < temp->cost) ){
            pq.push(C);
            break;
        }
        else{
